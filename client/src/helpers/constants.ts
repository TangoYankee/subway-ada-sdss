...
export const FACTOR_DISPLAY= {
  ...
  [FACTORS.UNDER_EIGHTEEN_AMBULATORY]: "Population under 18 with ambulatory disabilities",
  [FACTORS.OVER_EIGHTEEN_UNDER_SIXTY_FIVE_AMBULATORY]: "Population over 18 and under 65 with ambulatory disabilities",
  [FACTORS.SIXTY_FIVE_AND_OVER_AMBULATORY]: "Population sixty five and over with ambulatory disabilities",
}
